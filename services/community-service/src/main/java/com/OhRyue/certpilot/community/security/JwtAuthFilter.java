package com.OhRyue.certpilot.community.security;
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        try {
            ...
            if (userId != null && SecurityContextHolder.getContext().getAuthentication() == null) {
                ...
                log.debug("[community-service] ✅ JWT 인증 성공 - userId: {}, roles: {}, path: {}",
                        userId, Arrays.toString(roles), path);
            }

        } catch (Exception e) {
            log.warn("[community-service] ❌ JWT 인증 실패 - path: {}, error: {}", path, e.getMessage());
