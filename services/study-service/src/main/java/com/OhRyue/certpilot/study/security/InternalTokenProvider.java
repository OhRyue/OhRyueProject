 ...
 * - aud: cert-service | progress-service (대상별로 다르게)
 * - exp: 10~30분 (설정값)
 *
 * 알고리즘: HS256
 */
...
public class InternalTokenProvider {
    ...
    private static final String SUBJECT = "internal-study-service";
     ...
     * @param audience "cert-service" | "progress-service"
     */
    ...
    /** (옵션) 기존 호출부 호환용: 기본 audience=cert-service */
    public String generateInternalToken() {
        return generateInternalToken("cert-service");
    }
