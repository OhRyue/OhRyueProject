...
public class MainPracticalController {
  ...
  public FlowDtos.StepEnvelope<WrittenDtos.MiniSubmitResp> submitMini(@RequestBody @Valid WrittenDtos.MiniSubmitReq req) {
    return practical.submitMini(req);
  }

  @Operation(summary = "실기 미니체크 단건 즉시 채점")
  @PostMapping("/mini/grade-one")
  public WrittenDtos.MiniGradeOneResp gradeOneMini(@RequestBody @Valid WrittenDtos.MiniGradeOneReq req) {
  ...
  @PostMapping("/submit")
  public FlowDtos.StepEnvelope<PracticalSubmitResp> submit(@RequestBody @Valid PracticalSubmitReq req) {
  ...
  public FlowDtos.StepEnvelope<PracticalReviewSubmitResp> reviewSubmit(@RequestBody @Valid PracticalReviewSubmitReq req) {
