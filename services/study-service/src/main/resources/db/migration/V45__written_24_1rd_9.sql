...
/* =======================================================
 * Q89. 접근통제 정책 유형 (MAC/DAC/RBAC 비교)
 * ======================================================= */
INSERT INTO question (
  cert_id, topic_id, mode, type, difficulty,
  stem, answer_key, solution_text, source
