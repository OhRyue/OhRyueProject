...
public class ProgressServiceClientFallback implements ProgressServiceClient {
    ...
    @Override
    public VersusResultResponse recordVersusResult(VersusResultRequest request) {
        ...
        return new VersusResultResponse(request.mode(), request.roomId(), java.util.List.of());
    }
}
