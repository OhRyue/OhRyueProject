...
/**
 * V5__ability_wrong.sql 기준 매핑
 * PK: (user_id, question_id, tag)
 * 보조 인덱스: idx_wrong_note_user_status (user_id, status, last_wrong_at DESC)
 */
@Getter
@NoArgsConstructor
@Entity
...
public class WrongNote {
    ...
    /** 오답 1회 처리: wrong_count 증가, first/last 갱신, 상태 기본값 유지 */
